	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/sysLog/findAll.do">CASE管理</a></li>

				<li class="active">全部CASE</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
						...
						<table id="dataList"
							...
							<thead>
								<tr>
									...
									<th class="sorting">业务模块</th>
									<th class="sorting">菜单编码</th>
									<th class="sorting">菜单名称</th>
									<th class="sorting">用例描述</th>
									<th class="sorting">测试员</th>
							...
							<tbody>
								<c:forEach items="${sysLogs}" var="syslog">
									<tr>
										...
										<td>${syslog.visitTimeStr }测试逻辑</td>
										<td>${syslog.username }Testlogic</td>
										<td>${syslog.ip }</td>
										<td>${syslog.url}</td>
