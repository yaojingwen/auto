						...
						<table id="dataList"
							...
							<c:forEach items="${pageInfo.list}" var="user">
								<tr>
									...
									<td>
										<c:if test="${user.isUsed==1}">正常</c:if>
										<c:if test="${user.isUsed==2}">禁止登陆</c:if>
									</td>
									<td class="text-center">
										<a href="/user/one/${user.operatorId}" class="btn bg-olive btn-xs">详情</a>
				...
				<div class="box-footer">
					...
					<script>
                        goPage=function (size) {
                            location.href='/user/list?pageNum=1&rows='+size;
                        }
					</script>

					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/user/list" aria-label="Previous">首页</a></li>
							<li><a href="/user/list?pageNum=${pageInfo.prePage}&rows=${pageInfo.pageSize}">上一页</a></li>
							<c:forEach begin="${pageInfo.navigateFirstPage}" end="${pageInfo.navigateLastPage}" var="pi">
								<li><a href="/user/list?pageNum=${pi}&rows=${pageInfo.pageSize}">${pi}</a></li>
							</c:forEach>
							<li><a href="/user/list?pageNum=${pageInfo.nextPage}&rows=${pageInfo.pageSize}">下一页</a></li>
							<li><a href="/user/list?pageNum=${pageInfo.pages}&rows=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
