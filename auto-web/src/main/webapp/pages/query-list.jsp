...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				数据查询 <small>数据列表</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/sysLog/findAll.do">数据查询</a></li>
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/query.jsp'">
							...
							<tbody>
								<c:forEach items="${sysLogs}" var="syslog">
									<tr>
										...
										<td>${syslog.visitTimeStr }
											g_query_masSer_group</td>
										<td style="
												width: 600px;">${syslog.url}
											查询订购了MAS服务器商品的集团编号</td>
