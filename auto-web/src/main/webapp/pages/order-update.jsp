...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/id/${orders.id}" method="post">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="订单编号"
								 name="orderNum" value="${orders.orderNum}">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="出行人数"
								 name="peopleCount" value="${orders.peopleCount}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="payType">
								<option value="0" <c:if test="${orders.payType==0}">selected="selected" </c:if> >支付宝</option>
								<option value="1" <c:if test="${orders.payType==1}">selected="selected" </c:if>>微信</option>
								<option value="2" <c:if test="${orders.payType==2}">selected="selected" </c:if>>其他</option>
							</select>
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="orderStatus">
								<option value="0" <c:if test="${orders.orderStatus==0}">selected="selected" </c:if> >未支付</option>
								<option value="1" <c:if test="${orders.orderStatus==1}">selected="selected" </c:if> >已支付</option>
							</select>
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								...
								<c:forEach items="${ products }" var="p">
									<option value="${ p.id }" <c:if test="${p.id==orders.productId}">selected="selected" </c:if> >${ p.productName }</option>
								</c:forEach>
